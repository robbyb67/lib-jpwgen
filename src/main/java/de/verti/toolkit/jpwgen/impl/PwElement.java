...
/**
 * A helper construct representing an element used for the generation of passwords. An instance of this class is either
 * a vowel or a consonant. Both vowels and consonants can be marked as dipthongs. The marking is implemented as a bit
 * masked int. By using this class a pronounceable password is created which should be easy to remember.
 *
 * @author  unrz205
 */
public class PwElement {
	 ...
	 *
	 * @param  value  the string representation of the vowel, consonant (dipthong)
	 * @param  type   the type of the password element
	 */
	public PwElement(final String value, final int type) {
		this.value = value;
		this.type = type;
	}
