...
/**
 * Loads the ResourceBundle associated with the PwGenerator. This ResourceBundle contains the localized(externalized)
 * strings used by the classes.
 *
 * @author  unrz205
 */
public class Messages {
	 ...
	 */
	public static final String BUNDLE_NAME = "de.verti.toolkit.jpwgen.utils.messages"; //$NON-NLS-1$
	...
	/**
	 * Returns the localized message for this key. If the key is not found its value is returned surrounded by
	 * exclamation marks.
	 *
