...
public class PwGeneratorFlagBuilder implements Serializable {
	...
	protected static final Map<String, IPwFlag> SUPPORTED_FLAGS = new HashMap<String, IPwFlag>();
	...
	private List<IPwFlag> flagList = new ArrayList<IPwFlag>();
	...
	public PwGeneratorFlagBuilder(final Long flags) {
	...
	public PwGeneratorFlagBuilder(final List<IPwFlag> flagList) {
	...
	public static synchronized List<String> evalFlags(final Long flags) {
	...
	public static synchronized List<IPwFlag> loadFlags(final List<String> flagList) {
