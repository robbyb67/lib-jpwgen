...
public class StartsNoLowerCaseFlag extends AbstractCliFlag {

	private static final long serialVersionUID = 1L;

	public static final String CLI_SHORT = "b";

	public static final String CLI_LONG = "start-no-small-letter";

	public static final String CLI_DESCRIPTION = Messages
			.getString("IPwGenCommandLineOptions.CL_REGEX_STARTS_NO_LOWERCASE_DESC");

	public StartsNoLowerCaseFlag() {
		mask = REGEX_STARTS_NO_LOWERCASE_FLAG;
	...
	public String toString() {
		return "StartsNoLowerCaseFlag [cliShort=" + cliShort + ", cliLong="
